...
export const FuelWalk = {
  ...
  choices: [
    // Grass series
    { answer: 'nearly pure grass and/or forb type (Grass)',
      ask: 'the climate is',
      choices: [
        { answer: 'arid to semiarid (rainfall deficient in summer); extinction moisture content is 15%.',
          ask: 'the fuel bed is',
          choices: [
            { answer: 'short, patchy grass, and possibly heavily grazed.',
              ask: null, fuel: 'gr1', ros: 'moderate', flame: 'low'},
            { answer: 'moderately coarse and continuous grass',
              ask: 'the average grass depth is about',
              choices: [
                { answer: '1 foot', ask: null, fuel: 'gr2', ros: 'high', flame: 'moderate'},
                { answer: '2 feet', ask: null, fuel: 'gr4', ros: 'very high', flame: 'high'},
                { answer: '3 feet', ask: null, fuel: 'gr7', ros: 'very high', flame: 'very high'},
              ]
            }
          ]
        },
        { answer: 'subhumid to humid (rainfall adequate in all seasons); extinction moisture content is 30 - 40%.',
          ask: 'the fuel bed is',
          choices: [
            { answer: 'short, patchy grass; possibly heavily grazed',
              ask: null, fuel: 'gr1', ros: 'moderate', flame:'low'},
            { answer: 'very coarse grass, about 2 feet tall',
              ask: null, fuel: 'gr3', ros: 'high', flame:'moderate'},
            { answer: 'dense, coarse grass, about 1 to 2 feet tall',
              ask: null, fuel: 'gr5', ros: 'very high', flame: 'high'},
            { answer: 'dryland grass, about 1 to 2 feet tall',
              ask: null, fuel: 'gr6', ros: 'very high', flame:'very high'},
            { answer: 'heavy, coarse, continuous grass, about 3 to 5 feet tall',
              ask: null, fuel: 'gr8', ros: 'very high', flame:'very high'},
            { answer: 'very heavy, coarse, continuous grass, about 5 to 8 feet tall',
    ...
    // Grass-Shrub series
    { answer: 'mixture of grass and shrub, up to about 50 percent shrub coverage (Grass-Shrub)',
      ask: 'the climate is',
      choices: [
        { answer: 'arid to semiarid (rainfall deficient in summer); extinction moisture content is 15%.',
          ask: 'the fuel bed is',
          choices: [
            { answer: 'about 1 foot high with low grass load',
              ask: null, fuel: 'gs1', ros: 'moderate', flame: 'low'},
            { answer: 'about 1 to 3 feet high',
        ...
        { answer: 'subhumid to humid (rainfall adequate in all seasons); extinction moisture content is 30 - 40%.',
          ask: 'the fuel bed is',
          choices: [
            { answer: 'moderate load, less than 2 feet deep',
              ask: null, fuel: 'gs3', ros: 'high', flame: 'moderate'},
            { answer: 'heavy load, more than 2 feet deep',
    ...
    // Shrub series
    { answer: 'shrubs covering at least 50 percent of the site; grass sparse to nonexistent (Shrub)',
      ask: 'the climate is',
      choices: [
        { answer: 'arid to semiarid (rainfall deficient in summer); extinction moisture content is 15%.',
          ask: 'the fuel bed is',
          choices: [
            { answer: 'low load, about 1 foot deep; some grass may be present',
              ask: null, fuel: 'sh1', ros: 'very low', flame: 'very low'},
            { answer: 'moderate load, about 1 foot deep, no grass fuel present',
              ask: null, fuel: 'sh2', ros: 'low', flame: 'low'},
            { answer: 'heavy load, about 4 to 6 feet deep',
              ask: null, fuel: 'sh5', ros: 'very high', flame: 'very high'},
            { answer: 'very heavy load, about 4 to 6 feet deep',
        ...
        { answer: 'subhumid to humid (rainfall adequate in all seasons); extinction moisture content is 30 - 40%.',
          ask: 'the fuel bed is',
          choices: [
            { answer: 'moderate shrub load, possibly with pine overstory or herbaceous fuel, depth about 2 to 3 feet',
              ask: null, fuel: 'sh3', ros: 'low', flame: 'low'},
            { answer: 'low to moderate shrub and litter load, possibly with pine overstory, depth about 3 feet',
              ask: null, fuel: 'sh4', ros: 'high', flame: 'moderate'},
            { answer: 'dense shrubs, little or no herb fuel, depth about 2 feet',
              ask: null, fuel: 'sh6', ros: 'high', flame: 'high'},
            { answer: 'dense shrubs, little or no herb fuel, depth about 3 feet',
              ask: null, fuel: 'sh8', ros: 'high', flame: 'high'},
            { answer: 'dense, finely branched shrubs with significant fine dead fuel, depth about 4 to 6 feet; some herbaceous fuel may be present',
    ...
    { answer: 'grass or shrubs mixed with litter from forest canopy (Timber-Understory)',
      ask: 'the climate is',
      choices: [
        { answer: 'semiarid to subhumid climate; extinction moisture content is 20 percent.',
          ask: 'the fuel bed is',
          choices: [
            { answer: 'low load of grass and/or shrub with litter',
              ask: null, fuel: 'tu1', ros: 'low', flame: 'low'},
            { answer: 'short conifer trees with grass or moss understory',
              ask: null, fuel: 'tu4', ros: 'moderate', flame: 'moderate'},
            { answer: 'high load conifer litter with shrub understory',
              ask: null, fuel: 'tu5', ros: 'moderate', flame: 'moderate'},
          ],
        },
        { answer: 'humid climate; extinction moisture content is 30 percent.',
          ask: 'the fuel bed is',
          choices: [
            { answer: 'moderate litter load with shrub component',
              ask: null, fuel: 'tu2', ros: 'moderate', flame: 'low'},
            { answer: 'moderate litter load with grass and shrub components',
    ...
    { answer: 'dead and down woody fuel (litter) beneath a forest canopy (Timber Litter)',
      ask: 'is the fuel bed recently burned',
      choices: [
        { answer: 'fuel bed IS recently burned but able to carry wildland fire',
          ask: null, fuel: 'tl1', ros: 'very low', flame: 'very low',
          note: 'light to moderate load, fuels 1 to 2 inches deep'},
        { answer: 'fuel bed NOT recently burned.',
          ask: 'the fuel bed is composed primarily of',
          choices: [
            { answer: 'broadleaf (hardwood) litter',
              ask: 'the fuel bed is',
              choices: [
                { answer: 'low load and compact',
                  ask: null, fuel: 'tl2', ros: 'very low', flame: 'very low'},
                { answer: 'moderate load, less compact',
                  ask: null, fuel: 'tl6', ros: 'moderate', flame: 'low'},
                { answer: 'very high load, fluffy',
                  ask: null, fuel: 'tl9', ros: 'moderate', flame: 'low'},
              ],
            },
            { answer: 'long-needle pine litter',
              ask: null, fuel: 'tl8', ros: 'moderate', flame: 'low',
              note: 'moderate load and compactness; may include small amount of herbaceous load'
            },
            { answer: 'NOT composed of broadleaf or long-needle pine litter.',
              ask: 'does fuel bed include both fine and coarse fuels',
              choices: [
                { answer: 'yes, fuel bed DOES include both fine and coarse fuels.',
                  ask: 'the fuel bed is',
                  choices: [
                    { answer: 'moderate load, includes small diameter downed logs',
                      ask: null, fuel: 'tl4', ros: 'low', flame: 'low'},
                    { answer: 'heavy load, includes larger diameter downed logs',
                      ask: null, fuel: 'tl7', ros: 'low', flame: 'low'},
                  ]
                },
                { answer: 'no, fuel bed does NOT include coarse fuels',
                  ask: 'the fuel bed is',
                  choices: [
                    { answer: 'moderate load conifer litter',
                      ask: null, fuel: 'tl3', ros: 'very low', flame: 'low'},
                    { answer: 'high load conifer litter; light slash or mortality fuel',
                      ask: null, fuel: 'tl5', ros: 'low', flame: 'low'},
                    { answer: 'very high load broadleaf litter; heavy needle-drape in otherwise sparse shrub layer',
    ...
    { answer: 'activity fuel (slash) or debris from wind damage (blowdown) (Slash-Blowdown)',
      ask: 'the fuel is a result of',
      choices: [
        { answer: 'activity',
          ask: 'the fuel bed has',
          choices: [
            { answer: 'fine fuel load of 10 to 20 tons/acre, weighted toward fuels 1 to 3 inches diameter class, depth is less than 1 foot',
              ask: null, fuel: 'sb1', ros: 'moderate', flame: 'low'},
            { answer: 'fine fuel load of 7 to 12 tons/acre, evenly distributed across 0 to 0.25, 0.25 to 1, and 1 to 3 inch diameter classes, depth is about 1 foot',
              ask: null, fuel: 'sb2', ros: 'moderate', flame: 'moderate'},
            { answer: 'fine fuel load of 7 to 12 tons/acre, weighted toward 0 to 0.25 inch diameter class, depth is more than 1 foot',
        ...
        { answer: 'blow down',
          ask: 'the fuel bed is',
          choices: [
            { answer: 'scattered blowdown with many trees still standing',
              ask: null, fuel: 'sb2', ros: 'moderate', flame: 'moderate'},
            { answer: 'moderate blowdown, trees compacted to near the ground',
              ask: null, fuel: 'sb3', ros: 'high', flame: 'high'},
            { answer: 'total blowdown, fuelbed not compacted, foliage still attached',
